  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 dark:text-slate-400 mt-1">Sign in to your account to continue</p>
      </div>

      {/* Discord SSO */}
      <Button
        variant="outline"
        className="w-full h-11 gap-3 text-sm font-medium border-gray-200 hover:bg-gray-50 dark:border-slate-700 dark:hover:bg-slate-800"
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        <div className="space-y-1.5">
          ...
          <Input
            ...
            {...register("email")}
            disabled={loading}
            className="h-11 border-gray-200 dark:border-slate-700 focus-visible:ring-indigo-500"
          />
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            <Input
              ...
              {...register("password")}
              disabled={loading}
              className="h-11 pr-10 border-gray-200 dark:border-slate-700 focus-visible:ring-indigo-500"
            />
            <button
              type="button"
        ...
        <Button
          type="submit"
          className="w-full h-11 bg-indigo-600 hover:bg-indigo-700 text-white font-medium gap-2 shadow-sm shadow-indigo-200"
          disabled={loading}
        >
      ...
      <div className="pt-2 border-t border-gray-100 dark:border-slate-800">
        <p className="text-center text-xs text-gray-400">
          Are you staff?{" "}
          <Link href="/admin/login" className="text-gray-500 hover:text-gray-700 font-medium">
            Go to staff portal →
          </Link>
        </p>
      </div>
